export const TypingIndicator = ({ inline = false }: { inline?: boolean }) => (
  <div className={`flex items-center gap-1.5 animate-in fade-in zoom-in duration-300 ${inline ? 'py-1 h-[24px]' : 'px-4 py-3 bg-panel-2 rounded-2xl w-fit shadow-sm border border-edge'}`}>
